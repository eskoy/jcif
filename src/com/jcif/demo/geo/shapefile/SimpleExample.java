...
public class SimpleExample {
	...
	public static void main(String[] args) throws IOException, InvalidShapeFileException {
		...
		FileInputStream is = new FileInputStream("testdata/freefiles/polygonfiles/water.shp");
		...
		while ((s = r.next()) != null) {
			...
			case POLYGON:
				...
				System.out.println("I read a Polygon with " + aPolygon.getNumberOfParts() + " parts and "
