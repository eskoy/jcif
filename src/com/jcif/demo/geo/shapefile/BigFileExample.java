package com.jcif.demo.geo.shapefile;
...
public class BigFileExample {
	...
	public static void main(String[] args) throws IOException, InvalidShapeFileException {
		...
		FileInputStream is = new FileInputStream("testdata/freeworld/10m-coastline/10m_coastline.shp");

		// This file has shapes with more than 10000 points each. Therefore, we
		// need
		// to change the validation preferences to increase the limit of points
		// per
		// shape beyond that number. If we don't use the customized preferences,
		// the
		...
		while ((s = r.next()) != null) {
			...
			case POLYLINE:
				...
				System.out.println("I read a Polyline with " + aPolyline.getNumberOfParts() + " parts and "
